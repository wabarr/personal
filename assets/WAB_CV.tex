...
\item[] {\bfseries Barr WA}.  The morphology of the bovid calcaneus: function, phylogeny, and allometric scaling. 
\end{description*}
...
\begin{description*}
\item[] {\bfseries 2017}
\item[] Invited workshop organizer. Topic: \emph{Data Analysis, Visualization, and Comparative Methods in R}. February 16-17. University of North Carolina - Greensboro. 
\item[] {\bfseries 2015}
